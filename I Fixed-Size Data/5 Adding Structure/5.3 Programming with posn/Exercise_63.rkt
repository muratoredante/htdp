...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise_63) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
;(+
;  (sqrt
;  (+ (sqr 12) (sqr (posn-y (make-posn 12 5)))))
;  10)

;(+
;  (sqrt (+ 144 (sqr (posn-y (make-posn 12 5)))))
;  10)
